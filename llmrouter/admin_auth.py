...
from llmrouter.auth_store import AdminUser, ensure_admin, load_admin, verify_password
from llmrouter.secrets import jwt_signing_key, resolve_secret_key

SESSION_COOKIE = "llmrouter_session"
CSRF_COOKIE = "llmrouter_csrf"
JWT_TTL_S = 12 * 60 * 60
...
def cookie_secure(request_https: bool = False) -> bool:
    env = (os.environ.get("LLMROUTER_COOKIE_SECURE") or "").strip().lower()
